...
//	$(".dBox3Table tr td:last-child a").addClass(".PromoWrite");
	...
	//折扣管理修改
	$("#discountW1").click(function(){    //修改；
		$(".discBox").show();
	});
	$("#discountW2").click(function(){    //修改；
		$(".discBox").show();
	});
	$("#discountW3").click(function(){    //修改；
		$(".discBox").show();
	});
	$("#discountW4").click(function(){    //修改；
		$(".discBox").show();
	});
	$("#discountW5").click(function(){    //修改；
		$(".discBox").show();
	});
	$("#discountW6").click(function(){    //修改；
		$(".discBox").show();
	});
	$("#discountW7").click(function(){    //修改；
		$(".discBox").show();
	});
	$("#discountW8").click(function(){    //修改；
		$(".discBox").show();
	});
});
...
$(document).ready(function(){
	...
	//优惠券管理修改
	$("#couponW1").click(function(){   //新增；
		$(".coupBox").show();
	});
	$("#couponW2").click(function(){   //新增；
		$(".coupBox").show();
	});
	$("#couponW3").click(function(){   //新增；
		$(".coupBox").show();
	});
	$("#couponW4").click(function(){   //新增；
		$(".coupBox").show();
	});
	$("#couponW5").click(function(){   //新增；
		$(".coupBox").show();
	});
	$("#couponW6").click(function(){   //新增；
		$(".coupBox").show();
	});
	$("#couponW7").click(function(){   //新增；
		$(".coupBox").show();
	});
	$("#couponW8").click(function(){   //新增；
		$(".coupBox").show();
	});
});
...
$(document).ready(function(){
	...
	//满X优惠管理修改
	$("#favourW1").click(function(){
		$(".reachBox").show();
	});
	$("#favourW2").click(function(){
		$(".reachBox").show();
	});
	$("#favourW3").click(function(){
		$(".reachBox").show();
	});
	$("#favourW4").click(function(){
		$(".reachBox").show();
	});
	$("#favourW5").click(function(){
		$(".reachBox").show();
	});
	$("#favourW6").click(function(){
		$(".reachBox").show();
	});
	$("#favourW7").click(function(){
		$(".reachBox").show();
	});
});
//满X优惠管理；
...
$(document).ready(function(){
	...
	//赠送管理修改
	$("#giveW1").click(function(){      //新增
		$(".giveBox").show();         
	});
	$("#giveW2").click(function(){      //新增
		$(".giveBox").show();         
	});
	$("#giveW3").click(function(){      //新增
		$(".giveBox").show();         
	});
	$("#giveW4").click(function(){      //新增
		$(".giveBox").show();         
	});
	$("#giveW5").click(function(){      //新增
		$(".giveBox").show();         
	});
	$("#giveW6").click(function(){      //新增
		$(".giveBox").show();         
	});
	$("#giveW7").click(function(){      //新增
		$(".giveBox").show();         
	});
});
...
$(function(){
	...
	//红包管理修改
	$("#redpacketW1").click(function(){ 
		$(".redpacketBox").show();
	});
	$("#redpacketW2").click(function(){  
		$(".redpacketBox").show();
	});
	$("#redpacketW3").click(function(){  
		$(".redpacketBox").show();
	});
	$("#redpacketW4").click(function(){  
		$(".redpacketBox").show();
	});
	$("#redpacketW5").click(function(){ 
		$(".redpacketBox").show();
	});
	$("#redpacketW6").click(function(){  
		$(".redpacketBox").show();
	});
});
...
//折扣工具的批量打折部分input全选
$(function(){
    $("#checkalla").checkall({chname:"testa[]", callback: function(e){}});
});
//$(function(){
//  //全选按钮被选中的时候
//  $("#checkalla").click(function(){
//  //列表隐藏中的input也要被选中
//      if ($("#checkalla").prop("checked",true)) {
//      	$("#boxList1 input").prop("checked",true);
//      } 
//  })
//});

$(function(){
    $("#checkalla1").checkall({chname:"testa1[]", callback: function(e){}});
});
$(function(){
    $("#checkalla2").checkall({chname:"testa2[]", callback: function(e){}});
});
$(function(){
    $("#checkalla3").checkall({chname:"testa3[]", callback: function(e){}});
});
$(function(){
    $("#checkalla4").checkall({chname:"testa4[]", callback: function(e){}});
});
$(function(){
    $("#checkalla5").checkall({chname:"testa5[]", callback: function(e){}});
});
$(function(){
    $("#checkalla6").checkall({chname:"testa6[]", callback: function(e){}});
});